...
<div class="card mb-4" x-data="{openModalEdit: false, openModalCreate: false}">
    ...
    <x-modalAlpine modalName="openModalEdit" title="Edit">
        ...
        <form wire:submit="edit" class="max-w-sm mx-auto">
            ...
            <button type="submit" x-on:click="openModalEdit=false" class="mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
        </form>
    </x-modalAlpine>
